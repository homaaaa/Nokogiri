...
def transform_and_output(extract_array)
  ...
  email = extract_array.map { |j| j.match(/[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}/i).to_s }  #cherche dans chaque occurence la présence d'un e-mail (regex conçu pour les mails) et créé un array contenant chaque adresse sous forme de strings
